...
SlideDeck.prototype.loadConfig_ = function(config) {
  ...
  if (settings.title) {
    ...
    var docTitle = document.querySelector('[data-config-title]');
    if (docTitle) {
      document.querySelector('[data-config-title]').innerHTML = settings.title;
    }
  }

  var docSubtitle = document.querySelector('[data-config-subtitle]');
  if (docSubtitle && settings.subtitle) {
    docSubtitle.innerHTML = settings.subtitle;
  }
